...
public class Resources {
  ...
  /*TO do by adrian ***
   * change the port to the correct one as you design the hardware 
   */
  ...
  public static USLocalizer usl = new USLocalizer();
  public static LightLocalizer ll = new LightLocalizer();
